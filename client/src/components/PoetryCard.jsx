...
const PoetryCard = ({ poem, onLikeUpdate }) => {
  ...
  return (
    <>
      {/* Poetry Card */}
      <div className="bg-white rounded-lg shadow-lg p-6 h-[300px] flex flex-col justify-between hover:shadow-xl transition-all duration-300 transform hover:scale-105">
        <div>
          <h2 className="text-2xl font-poetry font-bold text-gray-800 mb-3 line-clamp-2">
            {poem.title}
          </h2>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-gray-600 hover:text-blue-600 hover:bg-blue-50 transition-colors text-sm"
              >
                View More
              </button>
            </div>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 transition-opacity duration-300">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg transform transition-all duration-300 animate-fadeIn">
            
            {/* Header */}
            <div className="flex justify-between items-center px-6 py-3 border-b">
              <h1 className="text-lg font-bold text-gray-800 mx-auto">Manav Diary</h1>
              <button
            ...
            <div className="px-6 py-4 max-h-[80vh] overflow-y-auto">
              <h2 className="text-2xl font-poetry font-bold text-gray-800 mb-4">
                {poem.title}
              </h2>
              <div className="text-gray-700 text-base leading-relaxed whitespace-pre-line font-elegant">
                {poem.content}
              </div>
            </div>
          </div>
