...
const BrokenPoetry = () => {
  ...
  const fetchPoetry = async () => {
    try {
      setLoading(true);
      const response = await poetryAPI.getByCategory('broken');
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="text-center">
          <div className="inline-block animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-gray-600"></div>
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 animate-fade-in">
      <div className="text-center mb-12">
        <h1 className="text-5xl md:text-6xl font-poetry font-bold text-gray-800 mb-4">Broken Poetry</h1>
        <p className="text-xl text-gray-600 font-elegant">Words from a broken heart</p>
      </div>
