...
const MotherPoetry = () => {
  ...
  const fetchPoetry = async () => {
    try {
      setLoading(true);
      const response = await poetryAPI.getByCategory('mother');
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12 animate-fade-in">
      <div className="text-center mb-12">
        <h1 className="text-5xl md:text-6xl font-poetry font-bold text-gray-800 mb-4">Mother Poetry</h1>
        <p className="text-xl text-gray-600 font-elegant">Tributes to the greatest love</p>
      </div>
